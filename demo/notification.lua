...
function service:Notify(app_name, id, icon, summary, body, actions, hints, timeout, return_id)
    print("NEW NOTIF",app_name, id, icon, summary, body, actions, hints, timeout, return_id)
    return 12
end
